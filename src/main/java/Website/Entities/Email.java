...
public class Email {
    ...
    public String getErrorMessage(){
        String out = "<h2>Invalid email, please try again.</h2><p>Valid emails must: <br>- not contain consecutive special characters<br>- not begin with a special character<br>- not contain any of the following characters:" +getSpecialChars() +"</p>";
            return out;
    }
}
