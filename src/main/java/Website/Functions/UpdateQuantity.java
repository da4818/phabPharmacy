...
public class UpdateQuantity {
    ...
    public UpdateQuantity(String name1, String brand1, int quantityChange) {
        ...
        try {
            ...
            // Checks if the product has been sold (e.g negative change in stock)
            if (quantityChange < 0) {
                float oldProfit = 0;
                float newProfit = 0;
                // Gets profit from day of sale
            ...
            if(update<hardMin){
                ...
                // If other members are below their soft minimum (e.g fullstock*0.2), we'll make an order for them as well
