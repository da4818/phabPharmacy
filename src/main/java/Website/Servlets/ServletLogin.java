...
public class ServletLogin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(LoginDAO.validateLogin(em,pw)){ // Checks that the input variables match existing entries in the customer ('user') database
            ...
            resp.getWriter().write("<h2 name=\"loginResponse\">Welcome back, " + currentUser.fname + "!</h2>\n");
        }
    ...
    public String htmlOutput(){
        ...
        return "<!DOCTYPE html>\n" + // HTML comments are on the respective .jsp files (need updating)
                ...
                "    <div class=\"dropdown\">\n" +
                "        <button href=\"https://phabpharmacy.herokuapp.com/home\" name=\"Browse\" style=\"cursor: pointer;\" class=\"dropbtn\" onclick=\"redirectBrowse()\"><i class=\"fa fa-fw fa-search\"></i>Browse<i class=\"fa fa-caret-down\"></i></button>\n" +
